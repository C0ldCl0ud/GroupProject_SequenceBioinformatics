...
rule touch_bam_dir_short:
    input:
        bams = expand(f"{SCRATCH_MAP}/multi/short/{{sample}}/{{other}}.sorted.bam", other=SAMPLES)
    output:
...
rule touch_bam_dir_long:
    input:
        bams = expand(f"{SCRATCH_MAP}/multi/long/{{sample}}/{{other}}.sorted.bam", other=SAMPLES)
    output:
...
rule touch_bam_dir_hybrid:
    input:
        bams = expand(f"{SCRATCH_MAP}/multi/hybrid/{{sample}}/{{other}}.sorted.bam", other=SAMPLES)
    output:
